...
/>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <ServiceCard 
              ...
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-teal" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <ServiceCard 
              ...
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-teal" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <path d="M11 17a6 6 0 0 0-12 0a1 1 0 1 0 2 0c0-2.21 1.79-4 4-4s4 1.79 4 4a1 1 0 0 0 2 0Z" />
  ...
  return (
    <ScrollReveal delay={delay}>
      <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 card-hover">
        ...
        <h3 className="text-xl font-dm-serif font-bold text-teal mb-2">{title}</h3>
        <p className="text-charcoal">{description}</p>
        <Link 
          to="/services" 
          className="inline-flex items-center text-teal hover:text-skyblue-medium mt-4 transition-colors duration-300 font-medium"
        >
          Learn More
