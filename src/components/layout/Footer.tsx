    ...
    <footer className="bg-royal text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-playfair font-bold mb-4 text-gold">Mirza Hospital</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/departments" className="hover:text-gold transition-colors duration-300">Departments</Link></li>
          ...
          <div>
            <h3 className="text-xl font-playfair font-bold mb-4 text-gold">Services</h3>
            <ul className="space-y-2">
              <li><Link to="/services" className="hover:text-gold transition-colors duration-300">Emergency Service</Link></li>
              <li><Link to="/services" className="hover:text-gold transition-colors duration-300">OPD</Link></li>
              <li><Link to="/services" className="hover:text-gold transition-colors duration-300">Surgery</Link></li>
              <li><Link to="/services" className="hover:text-gold transition-colors duration-300">Maternity</Link></li>
              <li><Link to="/services" className="hover:text-gold transition-colors duration-300">Critical Care</Link></li>
              <li><Link to="/services" className="hover:text-gold transition-colors duration-300">Diabetology</Link></li>
            </ul>
          </div>

          <div>
            <h3 className="text-xl font-playfair font-bold mb-4 text-gold">Contact Us</h3>
